...
export function ConsoleSidebar({ userEmail, userRole }: ConsoleSidebarProps) {
  ...
  return (
    <div className="flex h-screen w-56 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-4">
        <div className="text-xl font-bold text-blue-600">THEMISON</div>
