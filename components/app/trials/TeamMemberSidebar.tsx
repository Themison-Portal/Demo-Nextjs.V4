...
export function TeamMemberSidebar({
    ...
    const handleRemove = async () => {
        if (
            !confirm(
                `Are you sure you want to remove ${member.user?.full_name || member.user?.email || "this member"
                } from the trial team?${member.trial_role === "PI"
    ...
    const handleUpdateNotes = async (notes: string) => {
        await onUpdateSettings(member.id, {
            ...(member.settings || {}),
            notes,
        });
    };
    ...
    const notes = (member.settings as any)?.notes || "";
    const contactInfo = (member.settings as any)?.contact_info || "";
            ...
            <CardContent className="px-4 space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <SelectPopover
                        ...
                        onSelect={(value) =>
                            onUpdateRole(member.id, value as TrialRole)
                        }
