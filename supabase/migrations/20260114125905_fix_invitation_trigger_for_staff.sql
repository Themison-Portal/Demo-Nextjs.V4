-- Fix invitation acceptance trigger to handle staff users properly
-- Use FOUND variable instead of checking record fields
...
BEGIN
  ...
  IF OLD.email_confirmed_at IS NULL AND NEW.email_confirmed_at IS NOT NULL THEN
    ...
    -- Use FOUND instead of checking pending_invitation.id
    IF FOUND THEN
